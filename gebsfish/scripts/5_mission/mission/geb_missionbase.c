    ...
    override void InitWorldYieldDataDefaults(CatchYieldBank bank){
		...
		{	
			...
			if(gebsMissionLoaded == true) {
				...
				Print("[gebsfish] [Init] Adding fish to yield data");
				//fishies
				...
				Print("[gebsfish] [Init] Loading fish complete.");

				//start loading junk data
				Print("[gebsfish] [Init] Adding junk to yield data.");
				...
				Print("[gebsfish] [Init] Loading junk complete.");
